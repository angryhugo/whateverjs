...
$(function(){
	...
	//slider
	var sliderActiveClass = "sc-right-q-active";
    var $slide = $(".sc-right-slide");
	var $slideTabs = $slide.find(".sc-right-q");
    var $slideContents = $slide.find(".sc-right-a");
    ...
    //switch
    var switchActiveClass = "sc-right-tab-btn-active";
    var $switch = $(".sc-right-switch");
    var $switchTabs = $switch.find(".sc-right-tab-btn");
    var $switchContents = $switch.find(".sc-right-content li");
	...
	$(".header-btn, .pop-right-btn, .sc-left-btn-pop").bind("click", function(){
		$popMask.show();
		$popAlert.show();
	});

	$popAlertCloseBtn.bind("click", function() {
		$popMask.hide();
		$popAlert.hide();
	})
});